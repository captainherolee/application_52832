PROJECT_NAME     := nrf52832_s132
TARGETS          := nrf52832_xxaa
OUTPUT_DIRECTORY := _build

SDK_ROOT := ./lib/SDK/nRF5_SDK_17.1.0_ddde560
PROJ_DIR := .

$(OUTPUT_DIRECTORY)/nrf52832_xxaa.out: \
  LINKER_SCRIPT  := ./conf/nrf52832.ld
...
SRC_FILES += \
  ...
  $(PROJ_DIR)/lib/drivers/i2c/i2c.c \
  $(PROJ_DIR)/lib/drivers/pwm/pwm.c \
  $(PROJ_DIR)/lib/drivers/systimer/systimer.c \
  $(PROJ_DIR)/lib/drivers/systimer/watchdog.c \
  $(PROJ_DIR)/lib/drivers/uart/uart.c \
  $(PROJ_DIR)/src/comm/ble_system.c \
  $(PROJ_DIR)/src/db/db.c \
  $(PROJ_DIR)/src/device/chip.c \
  $(PROJ_DIR)/src/device/power_mgmt.c \
  $(PROJ_DIR)/src/peripheral/accel_mc3416.c \
  $(PROJ_DIR)/src/peripheral/light_sensor.c \
  $(PROJ_DIR)/src/main.c \
...
INC_FOLDERS += \
  ...
  $(PROJ_DIR)/conf \
  $(PROJ_DIR)/src \
  $(PROJ_DIR)/lib/drivers/i2c \
  $(PROJ_DIR)/lib/drivers/pwm \
  $(PROJ_DIR)/lib/drivers/systimer \
  $(PROJ_DIR)/lib/drivers/uart \
  $(PROJ_DIR)/src/comm \
  $(PROJ_DIR)/src/config \
  $(PROJ_DIR)/src/db \
  $(PROJ_DIR)/src/device \
  $(PROJ_DIR)/src/peripheral \
...
SDK_CONFIG_FILE := ./conf/sdk_config.h
